...
#' denominated in USD.
#'
#' @aliases ls_instruments ls_stocks ls_options ls_option_series ls_futures ls_future_series ls_currencies ls_non_currencies ls_exchange_rates ls_FX ls_bonds ls_funds ls_spreads ls_guaranteed_spreads ls_synthetics ls_derivatives ls_non_derivatives ls_calls ls_puts rm_instruments rm_stocks rm_options rm_option_series rm_futures rm_future_series rm_currencies rm_exchange_rates rm_FX rm_bonds rm_funds rm_spreads rm_synthetics rm_derivatives rm_non_derivatives
