...
#' @importFrom quantmod getQuote is.HLC is.OHLC OHLC is.BBO has.Bid has.Ask has.Op has.Ad has.Trade has.Price getPrice Op Cl Ad has.Cl getSymbols getSymbolLookup setSymbolLookup yahooQF has.Vo Vo getOptionChain importDefaults
